...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaInstagram, FaYoutube } from 'react-icons/fa';
    ...
    <section id="contact" className="section-padding bg-gradient-to-b from-white to-secondary-50">
      <div className="container-custom max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          {/* Email */}
          <div className="bg-gradient-to-br from-primary-50 to-beige-50 p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
            <FaEnvelope className="text-primary-600 mx-auto mb-4" size={40} />
          ...
          {/* Phone */}
          <div className="bg-gradient-to-br from-primary-50 to-beige-50 p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
            <FaPhone className="text-primary-600 mx-auto mb-4" size={40} />
          ...
          {/* Address */}
          <div className="bg-gradient-to-br from-primary-50 to-beige-50 p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
            <FaMapMarkerAlt className="text-primary-600 mx-auto mb-4" size={40} />
