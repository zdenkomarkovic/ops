      ...
      <div className="container-custom max-w-6xl">
        ...
        <div className="bg-gradient-to-br from-beige-50 to-primary-50 rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-8 md:p-12">
            <ul className="grid md:grid-cols-2 gap-6 mb-8">
              {content.values.items.map((value, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <span className="text-lg md:text-xl text-gray-800 font-semibold">{value}</span>
                </li>
              ))}
            </ul>

            {/* Message Section */}
            <div className="bg-primary-500 text-white p-6 md:p-8 rounded-xl shadow-lg mb-6">
            ...
            {/* Brand Statement */}
            <div className="bg-white/70 p-6 md:p-8 rounded-lg border-l-4 border-primary-600">
