    ...
    >
      <div className="container-custom w-full">
        <div className=" mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm border-l-4 border-primary-500 p-4 md:p-6 rounded-lg shadow-lg max-w-4xl mx-auto text-center">
            <p className="text-lg md:text-2xl lg:text-3xl font-semibold text-primary-500 italic">
